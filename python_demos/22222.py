...
labels_in = np.ones((15, 512, 512), dtype=np.int32)
...
labels_out = cc3d.dust(labels_in, threshold=100, connectivity=26, in_place=False)
...
surface_per_contact = cc3d.contacts(
    labels_out, connectivity=connectivity, surface_area=True, anisotropy=(4, 4, 40)
)
