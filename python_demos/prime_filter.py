...
rs = round(reduce(lambda x, y: x+y, list(map(lambda x: math.sqrt(x), list(filter(lambda x: not list(filter(lambda i: x%i==0, range(2, int(math.sqrt(x))+1))), range(2,100+1)))))), 2)
print(rs)
